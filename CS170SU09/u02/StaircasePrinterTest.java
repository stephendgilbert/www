...
import java.util.*;
/**
 *  CS 170 Homework 2A Test Program.
 *
 *  @author  Stephen Gilbert
 *  @version Summer 2008
 */
public class StaircasePrinterTest extends junit.framework.TestCase
{
    private final String className = "StaircasePrinter";
    ...
    /**
     * Creates a new StaircasePrinterTest object.
     */
    public StaircasePrinterTest()
    {
        try {
    ...
    {
        assertNotNull("No " + className + " class defined", thisClass);
    }
