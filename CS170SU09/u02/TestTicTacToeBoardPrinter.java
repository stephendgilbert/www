 ...
 *  @version Summer 2008
 */
public class TestTicTacToeBoardPrinter extends junit.framework.TestCase
{
    ...
    /**
     * Creates a new TestTicTacToeBoardPrinter test object.
     */
    public TestTicTacToeBoardPrinter()
    {
        try {
     ...
     */
    @Hint("You don't seem to have created the TicTacToeBoardPrinter class correctly")
    @ScoringWeight(0.5)
    ...
    public void testMainDefined()
    {
        assertTrue("Your class should have a method named main()",
            methods != null && methods.length == 1 && methods[0].getName().equals("main"));
    }
