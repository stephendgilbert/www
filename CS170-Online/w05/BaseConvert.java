...
/** BaseConvert.java: A CS 170 in-class exercise.
 *  Converts base 10 numbers to another base (at most 4 digits in
 *  the other base).  The base 10 number and the base are input.
 *
 *  @author (Add your name here)
 *  @version (Add today's date here)
 */
