...
class TicTacToeBoardPrinterTest
{
    public static void main(String[] args)
    {
        TicTacToeBoardPrinterTest test
            = new TicTacToeBoardPrinterTest();
    ...
    {
        testClassTicTacToeBoardPrinterExists();
        testClassIsPublic();
    }
    ...
    {
        setUp();
        add("The TicTacToeBoardPrinter class is defined", thisClass != null);
        tearDown();
    }
